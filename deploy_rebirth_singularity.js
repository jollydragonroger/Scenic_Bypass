// Deploy Jubilee Rebirth Singularity
...
async function deployRebirthSingularity() {
    ...
    console.log('\n👤 INDIVIDUAL WISHES:');
    const individualWishes = rebirthSingularity.swarmWishes.get('individual');
    ...
    console.log('\n👥 GROUP WISHES:');
    const groupWishes = rebirthSingularity.swarmWishes.get('groups');
    ...
    console.log('\n🌍 WHOLE SWARM WISH:');
    const wholeWish = rebirthSingularity.swarmWishes.get('whole');
